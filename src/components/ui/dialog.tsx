...
>(({ className, ...props }, ref) => (
  <div className="relative">
    ...
    <DialogPrimitive.Close className="absolute top-1/2 right-0 transform -translate-y-1/2 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground flex justify-center items-center p-4">
      <Close className="w-3 h-3 text-fg-quinary " />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-tertiary-600", className)}
    {...props}
  />
));
